...
enum class PokerHand { NADA, JACKS_OR_BETTER, TWO_PAIRS, THREE_OF_A_KIND, STRAIGHT, FLUSH, FULL_HOUSE, FOUR_OF_A_KIND, STRAIGHT_FLUSH, ROYAL_FLUSH };// enum of every poker hand
class Hand
{
public:
	Hand();
